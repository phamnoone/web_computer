...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th class="title"><a class="title" href="<?php echo getLinkSort(2); ?>">Tên người dùng</a></th>
		<th class="title"><a class="title" href="<?php echo getLinkSort(5); ?>">Địa chỉ</a></th>
		<th class="title"><a class="title" href="<?php echo getLinkSort(8); ?>">Số điện thoại</a></th>
		<th class="title"><a class="title" href="<?php echo getLinkSort(10); ?>">Email</a></th>
		<th class="title"><a class="title" href="<?php echo getLinkSort(12); ?>">Tên đăng nhập</a></th>
		<th class="title"><a class="title" href="<?php echo getLinkSort(12); ?>">Mật khẩu</a></th>
...
$sql="select * from tbl_member limit ".($p*$MAXPAGE).",".$MAXPAGE;
