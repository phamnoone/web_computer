...
<?php switch ($_GET['action']){
	case 'del' :
		$id = $_GET['id'];
		@$result = mysql_query("update tbl_product set new = '0' where id = '".$id."'",$conn);
...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th class="title" colspan="1" nowrap></th>
		<th width="309" class="title"><a class="title" href="<?php echo getLinkSort(1)?>">Mã sản phẩm</a></th>
	...
	<tr>
		...
		<td width="30" align="center" bgcolor="<?php echo $color?>" class="smallfont">
			<a 
				...
				href="./?act=product_new&action=del&id=<?php echo $row['id']?>"
			>Xóa</a>		</td>
...
<table width="100%">
	...
	<tr><td class="smallfont"><?php echo 'Tổng số hàng : <b>'.countRecord($tableConfig,"new !=0").'</b>'?></td></tr>
</table>