...
if (isset($_POST['btnLogin'])){
	...
	$sql = "select * from tbl_administrator where uid='".$uid."' and pwd='".$pwd."' limit 1";
	if ( mysql_fetch_row(mysql_query($sql))>0) {
		$log = $uid;
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
    <td colspan="3" valign="middle" height="1px" style="background-image:url(images/login_line_top.jpg)"></td>
        ...
        <tr>
          <td align="center"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <h1 id="title" class="font_bule"><center>Quản trị website</center></h1>
                    ...
                    <td width="60%" align="left" valign="top"><table width="250" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                              <tr>
                                <td class="font_xam">Tên đăng nhập</td>
                                <td><input type="text" name="txtUid" size="20"></td>
                              </tr>
                              <tr>
                                <td valign="top" class="font_xam">Mật khẩu</td>
