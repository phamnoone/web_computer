<?php switch ($_REQUEST['frame']){
	...
	case "km"				 : $title = $_lang=="vn" ? "Khuyến mãi" : "New product";break;
	case "km_m"				 : $title = $_lang=="vn" ? "Chi tiết khuyến mãi" : "New product";break;
	case "ph"				 : $title = $_lang=="vn" ? "Ý kiến phản hồi" : "New product";break;
