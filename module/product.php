...
<?php for($j=0; $j<$col&&$products=mysql_fetch_assoc($result); $j++){
		...
		<table width="130" border="0" cellspacing="0" cellpadding="0" style="float:left">
			...
			<tr>
            <td height="100%" width="100%" align="center"><a href="./?frame=product_detail&id=<?php echo $pro['id']?>" class="link4" width="100%"><?php echo $pro['name']?><br><br><?php echo number_format($pro['price'],0,',','.')?></a></td>
