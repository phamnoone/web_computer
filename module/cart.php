...
<table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#000000" style="border-collapse:collapse">
	<tr>
		...
		<th class="smallfont"><center>Mã sản phẩm</center></th>
...
foreach ($cart as $product){
	...
	<tr>
		...
		<td align="center"><?php echo number_format($pro['price']*(100-$pro['km'])/100,0)?></td>
		<td align="center"><?php echo number_format(($pro['price']*(100-$pro['km'])/100*$product[1]),0)?></td>
		<td align="center">
