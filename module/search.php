...
<?php $where="1=1";
	...
	if ($keyword!=''){
		$where .= " and (detail_short like '%".$keyword."%' ";
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
 ...
 <tr>
 		<font face="verdana" size="2"  color="red"><b> Từ khóa: </b> </font><?php echo  $keyword?> </br>
 		<font face="verdana" size="2"  color="red"><b> Giá từ : </b></font> <?php echo  number_format($_REQUEST['pfrom'],0,',','.')?> 
 		<font face="verdana" size="2"  color="red"><b> Giá đến : </b> </font><?php echo   number_format($_REQUEST['pto'],0,',','.')?> <br>
 </tr>
<?php for($i=0; $i<$row; $i++){
?>
	<tr>
...
<?php for($j=0; $j<$col&&$products=mysql_fetch_assoc($result); $j++){
		...
		<table width="130" border="0" cellspacing="0" cellpadding="0" style="float:left">
			...
			<tr>
            <td height="25" align="left"><a href="./?frame=product_detail&id=<?php echo $pro['id']?>" class="link4"><center><?php echo $pro['name']?><br><?php echo number_format($pro['price'],0,',','.')?></a></center></td>
